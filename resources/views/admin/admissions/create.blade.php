            ...
            <div class="card-body">
               <div class="row">
                  <div class="col-lg-12 order-lg-1">
                     ...
                     <form action="{{ isset($admissions) ? route('frenchies.admission.update', $admissions->id) : route('frenchies.admission.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if(isset($admissions))
                        @method('PUT')
                        @endif
                                 ...
                                 <select class="form-control" name="center_id" id="center_id">
                                    ...
                                    @foreach($centers as $center)
                                          <option value="{{ $center->id }}"
                                             {{ (auth()->guard('frenchies')->check() && auth()->guard('frenchies')->user()->id == $center->id) 
                                                || old('center_id', $admissions->center_id ?? '') == $center->id 
                                                ? 'selected' : '' }}>
