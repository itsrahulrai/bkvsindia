...
@section('title', ' Women  - Bhartiya Kaushal Vikas Sansthan')
@section('content')
                    ...
                    <div class="col-12">
                        <div class="breadcrumb__content">
                            ...
                            <nav class="breadcrumb">
                                ...
                                <span property="itemListElement" typeof="ListItem"> Women </span>
                            </nav>
                        </div>
                    </div>
                </div>
        ...
        <section class="about-area-three section-py-120">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6">
                        <img src="{{ asset('front-assets/img/certificate/women.jpg') }}" alt="">
                    </div>
                </div>
            </div>
        </section>
