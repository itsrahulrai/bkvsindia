                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12 order-lg-1">
                            ...
                            <form action="{{ route('admin.marksheet.update',$certificate->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <table class="table" id="subjects-table">
                                        ...
                                        <tbody>
                                            ...
                                            @php
                                            // Check if marks_obtained and internal_marks are available for this subject
                                            $hasMarks = isset($marksData[$subject->id]['marks_obtained']) && isset($marksData[$subject->id]['internal_marks']);
                                            @endphp
