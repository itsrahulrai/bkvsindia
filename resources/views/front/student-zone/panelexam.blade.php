...
@section('title', ' Panel Exam - Bhartiya Kaushal Vikas Sansthan')
@section('content')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb__content">
                            <h3 class="title"> Panel Exam </h3>
                            <nav class="breadcrumb">
                                <span property="itemListElement" typeof="ListItem">
                                    <a href="{{ url('/') }}">Home</a>
                                </span>
                                <span class="breadcrumb-separator"><i class="fas fa-angle-right"></i></span>
                                <span property="itemListElement" typeof="ListItem"> Panel Exam </span>
                            </nav>
                        </div>
                    </div>
                </div>
