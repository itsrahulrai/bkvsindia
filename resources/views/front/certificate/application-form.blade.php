...
@section('title', ' Application Form - Bhartiya Kaushal Vikas Sansthan')
@section('content')
                    ...
                    <div class="col-12">
                        <div class="breadcrumb__content">
                            ...
                            <nav class="breadcrumb">
                                ...
                                <span property="itemListElement" typeof="ListItem"> Application Form </span>
                            </nav>
                        </div>
                    </div>
                </div>
        ...
        <section class="about-area-three section-py-120">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-12">
                        <iframe src="{{ asset('front-assets/img/certificate/application-form.pdf') }}" width="100%" height="900px"
