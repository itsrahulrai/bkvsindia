...
@section('title', ' Ministry of Labour - Bhartiya Kaushal Vikas Sansthan')
@section('content')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb__content">
                            <h3 class="title"> Ministry of Labour  </h3>
                            <nav class="breadcrumb">
                                <span property="itemListElement" typeof="ListItem">
                                    <a href="{{ url('/') }}">Home</a>
                                </span>
                                <span class="breadcrumb-separator"><i class="fas fa-angle-right"></i></span>
                                <span property="itemListElement" typeof="ListItem"> Ministry of Labour </span>
                            </nav>
                        </div>
                    </div>
                </div>
        ...
        <section class="about-area-three section-py-120">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6">
                        <img src="{{ asset('front-assets/img/certificate/ministry-of-labour.jpeg') }}" alt="">
                    </div>
                </div>
            </div>
        </section>
