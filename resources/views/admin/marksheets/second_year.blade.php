                                    ...
                                    <td align="left">
                                        <table align="left" border="0">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2" style="font-size:22px; font-family:calibri; font-weight:bold; padding-top:115px; padding-right: 30px;" align="right">&nbsp; Enrollment No: {{$marksheet->enroll_no}}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        <table width="1100" border="0" align="center" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="4" style="font-size:16px; font-family:calibri; padding:4px;">: &nbsp; &nbsp; {{$marksheet->student_name}} </td>
                                                <td align="left" colspan="2" rowspan="4">
                                                    <img src="{{asset($marksheet->photo)}}" width="100" height="100">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                                ...
                                                <td colspan="4" style="font-size:16px; font-family:calibri; padding:4px;">: &nbsp; &nbsp; {{$marksheet->father_name}} </td>
                                                <td colspan="2">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                                ...
                                                <td colspan="4" style="font-size:16px; font-family:calibri; padding:4px;">: &nbsp; &nbsp; {{$marksheet->mother_name}}</td>
                                                <td colspan="2">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                                ...
                                                <td colspan="4" style="font-size:16px; font-family:calibri; padding:4px;">: &nbsp; &nbsp; {{$marksheet->dob}}</td>
                                                <td colspan="2">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                                ...
                                                <td colspan="4" style="font-size:16px; font-family:calibri; padding:2px;">: &nbsp; &nbsp; {{$marksheet->roll_no}}</td>
                                                <td colspan="2">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                                ...
                                                <td colspan="4" style="font-size:16px; font-family:calibri; padding:2px;">
                                                    : &nbsp; &nbsp;
                                                    {{
        $marksheet->course_program === 'two_year'
            ...
            : ''
                                            ...
                                            <div>
                                                ...
                                                @foreach($courseDetails->subjects ?? [] as $index => $subject)
                                                @php
                                                ...
                                                <tr height="30">
                                                    ...
                                                    <td align="center" style="font-size:17px; font-family:calibri; font-weight:bold; padding:2px; border-top:2px #000000 solid; border-left:1px #000000 solid;">
                                                        <strong>{{ $totalMinimumMarks ?? 'Not Available' }}</strong>
                                                    </td>
                                                    <td align="center" style="font-size:17px; font-family:calibri; font-weight:bold; padding:2px; border-top:2px #000000 solid; border-left:1px #000000 solid;">
                                                ...
                                                <tr height="30">
                                                    ...
                                                    <td style="font-size:17px; font-family:calibri; font-weight:bold; padding:2px; border-top:1px #000000 solid; border-left:1px #000000 solid;"><strong>700</strong></td>
                                                ...
                                                <tr height="20" style="border-bottom:1px solid #000">
                                                    ...
                                                    <td style="font-size:17px; font-family:calibri; font-weight:bold; padding:2px; border-top:1px #000000 solid; border-left:1px #000000 solid; border-bottom:1px #000000 solid;"><strong>491</strong></td>
