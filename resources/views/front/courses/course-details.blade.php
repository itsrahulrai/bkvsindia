                    ...
                    <div class="col-xl-9 col-lg-8">
                        ...
                        <div class="courses__details-content">
                            ...
                            <div class="courses__details-meta">
                                <ul class="list-wrap">
                                    <li class="author-two">
                                        <img src="{{ asset('front-assets/img/courses/course_author001.png') }}"
                                            alt="img">
                                        By
                                        <a href="#">Admin </a>
                                    </li>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="overview-tab-pane" role="tabpanel"
                                    ...
                                    <div class="courses__overview-wrap">
                                        ...
                                        <p class="last-info">Morem ipsum dolor sit amet, consectetur adipiscing elit, sed
                                            do eiusmod tempor incididunt ut labore et dolore magna aliqua Quis ipsum
                                            suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan.Dorem
                                                                ...
                                                                <a href="#" class="course-item-link">
                                                                    ...
                                                                    <div class="course-item-meta">
                                                                        ...
                                                                        <span class="item-meta course-item-status">
                                                                            <img src="{{ asset('front-assets/img/icons/lock.svg') }}"
                                                                                alt="icon">
                                                                        </span>
                                                                    </div>
                                                                </a>
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="courses__details-sidebar">
                            ...
                            <div class="courses__cost-wrap">
                                ...
                                <h2 class="title"> 4,000 <del> 5,000</del></h2>
                            </div>
                            <div class="courses__information-wrap">
                                <h5 class="title">Course includes:</h5>
                                <ul class="list-wrap">
                                    <li>
                                        <img src="{{ asset('front-assets/img/icons/course_icon01.svg')}}" alt="img" class="injectable">
                                        Level
                                        <span>Expert</span>
                                    </li>
                                    <li>
                                        <img src="{{ asset('front-assets/img/icons/course_icon02.svg')}}" alt="img" class="injectable">
                                        Duration
                                        <span>11h 20m</span>
                                    </li>
                                    <li>
                                        <img src="{{ asset('front-assets/img/icons/course_icon03.svg')}}" alt="img" class="injectable">
                                        Lessons
                                        <span>12</span>
                                    </li>
                                    <li>
                                        <img src="{{ asset('front-assets/img/icons/course_icon04.svg')}}" alt="img" class="injectable">
                                        Quizzes
                                        <span>145</span>
                                    </li>
                                    <li>
                                        <img src="{{ asset('front-assets/img/icons/course_icon05.svg')}}" alt="img" class="injectable">
                                        Certifications
                                        <span>Yes</span>
                                    </li>
                                    <li>
                                        <img src="{{ asset('front-assets/img/icons/course_icon06.svg')}}" alt="img" class="injectable">
                                        Graduation
                                        <span>25K</span>
                                    </li>
                                </ul>
                            ...
                            <div class="courses__payment">
                                ...
                                <img src="{{ asset('front-assets/img/others/payment.png')}}" alt="img">
                            </div>
                            ...
                            <div class="courses__details-enroll">
                                <div class="tg-button-wrap">
                                    <a href="courses.html" class="btn btn-two arrow-btn">
                                        See All Instructors
                                        <img src="{{ asset('front-assets/img/icons/right_arrow.svg')}}" alt="img" class="injectable">
                                    </a>
                                </div>
                            </div>
                        </div>
